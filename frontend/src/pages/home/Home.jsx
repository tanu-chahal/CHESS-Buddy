...
const Home = () =>{
    ...
    return (
        ...
        <div className="container">
            ...
            {
                currentUser && <div className="copy">
                    <h1>Play chess with your best buddies on <span className="logo"><span className="chess">Chess</span><span className="buddy">BUDDY</span></span></h1>
                </div>
            }
            {!currentUser && <div className="intro">
            <div className="msg">
                    <p>Welcome to</p>
                </div>
                <div className="logo">
